...
parser.add_argument(
    '--tensorboad_resource_name',
    dest='tensorboad_resource_name',
    type=str,
    default=None)
parser.add_argument(
    '--tensorboard_experiment_name',
    dest='tensorboard_experiment_name',
    type=str,
    default=None)
parser.add_argument(
    '--gcp_resources',
...
"""
 Args:
            tensorboad_resource_name (str): Required. A fully-qualified
              tensorboard resource name.
                Example: "projects/123/locations/us-central1/tensorboards/456"
            tensorboard_experiment_name (str): Optional. The name of Tensorboard
              Experiment that will be used or created in the pipeline.
                Exmaple: 789
"""
...
def main(argv):
  ...
  tensorboard_resource_name = parsed_args.tensorboad_resource_name
  tensorboard_experiment_name = parsed_args.tensorboard_experiment_name
  ...
  tensorboard_experiment_resource_name = tensorboard_resource_name + '/experiments/' + tensorboard_experiment_name
