...
"""Deprecated. See nkfp.v2.components.types.type_utils instead.
...
warnings.warn(
    'Module nkfp.dsl.type_utils is deprecated and will be removed'
    ' in KFP v2.0. Please use from nkfp.v2.components.types.type_utils instead.',
